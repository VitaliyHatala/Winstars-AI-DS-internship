...
Each model follows a common interface so that the classifier can be easily switched without changing the rest of the code.
...
Machine learning model based on an ensemble of decision trees.
...
It takes the algorithm name as an input parameter:
...
This design ensures that the input/output structure remains identical regardless of the selected model.
